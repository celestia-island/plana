...
fn merge(original_contents: String, new_contents: String) -> String {
    ...
    let import_lines = original_header
        ...
        .filter_map(|line| {
            // A header may contain no imports at all (e.g. a file whose
            // types are all self-contained): skip non-import lines instead
            // of panicking on the ` from ` split.
            let (import, from) = line.split_once(" from ")?;
