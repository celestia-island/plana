...
2. 큰 변경은 먼저 issue에서 논의하십시오.
3. 커밋은 원자적(atomic)으로, Conventional Commits를 따르십시오.
4. `just ci`(또는 저장소의 CI 명령)가 통과하는지 확인하십시오.
5. CLA에 서명하고 `Signed-off-by`를 추가하십시오.
6. 리뷰 의견에 답변하십시오. force-push는 rebase 용도로만 사용하십시오.
