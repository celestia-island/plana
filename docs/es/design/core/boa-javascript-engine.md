...
2. Ser **seguro y aislado** — el código generado por LLM no es confiable por naturaleza.
3. Soportar **importaciones de módulos ES** para el mecanismo de despacho de herramientas (ej., `import { file_read } from 'agent'`).
4. Tener **sobrecarga de inicio mínima** — los contenedores son efímeros y deben estar listos rápidamente.
5. Ser **multiplataforma** y fácil de compilar para el objetivo del contenedor.
