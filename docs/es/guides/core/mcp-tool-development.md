...
2. **Despacho de Registry** — Enrutamiento, ubicado en `packages/agents/<agent>/src/mcp/registry.rs`
3. **Constantes de nombre de herramienta** — Constantes de cadena, ubicadas en `packages/shared/domain_skills/src/tool_names.rs`
