...
2. **Registry dispatch** — the routing, in `packages/agents/<agent>/src/mcp/registry.rs`
3. **Tool name constant** — a string constant, in `packages/shared/domain_skills/src/tool_names.rs`
