...
Arona puede controlar sistemas físicos e industriales, por lo que **la
...
forma privada vía [GitHub Security Advisories](https://github.com/celestia-island/arona/security/advisories/new).
