...
2. **Регистрация** — сохранение в реестре активов
3. **Анализ** — ApoRia оценивает медиа с помощью мультимодальной LLM
4. **Выявление проблем** — извлечение конкретных улучшений из анализа
5. **Уточнение** — multimedia-creation корректирует параметры на основе обратной связи и перегенерирует
6. **Повторный анализ** — ApoRia оценивает уточнённый вывод
