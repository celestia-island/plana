...
// (packages/celestia-types/bindings) is not an npm workspace member, so this MUST stay
// type-only: it is erased at build time and never reaches downstream bundlers.
import type { HealthResponse, NetworkInfo } from "../../../celestia-types/bindings/httpTypes";
