...
import Camera from "lucide-vue-next/dist/esm/icons/camera";
import Languages from "lucide-vue-next/dist/esm/icons/languages";
...
export const PAdminHeader = defineComponent({
