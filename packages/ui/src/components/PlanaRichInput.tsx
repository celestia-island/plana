...
import type { PAttachmentItem, PVoiceState } from "./PlanaChatTypes";
import { PVoiceInputPopup } from "./PlanaVoiceInputPopup";
import { formatBytes } from "../utils/format";
import "./PlanaRichInput.scss";
...
/**
 * PRichInput — the canonical chat composer.
 *
 ...
 */
export const PRichInput = defineComponent({
  name: "PlanaRichInput",
  props: {
    ...
    /**
     * Voice state fed by the parent (e.g. from a useVoiceInput
     * composable). When null the mic button emits `voiceToggle` but no
     * popup is rendered.
     */
    voice: { type: Object as PropType<PVoiceState | null>, default: null },
    /** Attachment strip rows — parent-owned upload state. */
    attachments: {
      type: Array as PropType<PAttachmentItem[]>,
      default: () => [],
    },
  ...
  emits: {
    ...
    submit: (_text: string, _attachments?: PAttachmentItem[]) => true,
    keydown: (_e: KeyboardEvent) => true,
    pickAttachment: () => true,
    removeAttachment: (_id: string) => true,
    previewAttachment: (_item: PAttachmentItem) => true,
      ...
      <div class="s-rich-input">
        ...
        {attachmentsEnabled.value && dragOver.value && (
          <div class="s-rich-input-drag-overlay">
            <Paperclip size={32} />
            <span>{t("plana::chat.dropFilesHere", "Drop files here to attach")}</span>
          </div>
        )}
        ...
        <div class="s-rich-input-tools">
          ...
          {attachmentsEnabled.value && (
            <HButton
              ...
              ariaLabel={t("plana::chat.attachFile", "Attach file")}
            ...
            slots.voice ? (
              ...
              <span ref={micBtnRef} class="s-rich-input-mic-anchor">
                <HButton
                  ...
                  ariaLabel={props.micLabel ?? t("plana::chat.voiceInput", "Voice input")}
          ...
          {!props.hideSend && (
            slots.send ? (
              ...
              <HButton
                ...
                aria-label={props.sendLabel ?? t("plana::chat.send", "Send")}
              >
                <Send size={14} />
