...
//!
//! NOTE: This is the TS-bindings copy. The canonical wire-layer copy lives in
//! the `jsonrpc` module (`crate::jsonrpc::types`). The two are kept in sync
//! manually — they define the same types but this copy additionally
//! exports TypeScript bindings. A future refactor could extract the envelope
//! into a shared leaf module to eliminate this duplication.
