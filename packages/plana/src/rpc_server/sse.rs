...
//!
//! Pairs with the browser-side SSE transport in `@celestia-island/plana-rpc-client`.
//! Sends an immediate `:connected` comment and periodic `:heartbeat` keep-alive frames
//! to prevent proxy/nginx timeout.
