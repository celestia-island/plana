...
export type GoalTaskCompleteParams = {
  task_id: string;
...
export type GoalTaskCreateParams = {
  track_id: string;
  title: string;
  description: string | null;
...
export type GoalTaskListParams = {
...
export type GoalTaskUpdateParams = {
  task_id: string;
  title: string | null;
  description: string | null;
  status: string | null;
