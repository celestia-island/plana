...
impl SoulLoader {
    ...
    pub fn is_valid_lang(lang: &str) -> bool {
        matches!(
            lang,
            "en" | "zh-Hans" | "zhs" | "zh-Hant" | "zht" | "ja" | "ko" | "fr" | "es" | "ru"
        )
    }

    pub fn normalize_lang(lang: &str) -> String {
        match lang.to_lowercase().as_str() {
            "zh" | "zh-cn" | "zh_hans" | "zhs" => "zh-Hans".to_string(),
            "zh-tw" | "zh_hk" | "zh_hant" | "zht" => "zh-Hant".to_string(),
            "jp" => "ja".to_string(),
            "kr" => "ko".to_string(),
...
mod tests {
    ...
    fn test_normalize_lang() -> Result<()> {
        ...
        assert_eq!(SoulLoader::normalize_lang("zhs"), "zh-Hans");
        assert_eq!(SoulLoader::normalize_lang("zh-tw"), "zh-Hant");
        assert_eq!(SoulLoader::normalize_lang("zht"), "zh-Hant");
