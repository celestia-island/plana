...
//!
//! The single canonical definition of these codes lives in the foundation's
//! `plana::jsonrpc::types::error_codes`; this module simply
...
//! standard error codes live in `plana::jsonrpc` as well — a former second
//! copy in the generic core was removed after the copies drifted apart.
