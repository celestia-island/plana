...
es = "Razonamiento causal por correlación cruzada entre una variable objetivo y candidatas"
ru = "Причинно-следственный анализ перекрёстной корреляции между целевой и кандидатными переменными"
+++
