...
zh-Hans = "snapshot_store是Epieikeia智能体的核心技能，专为管理容器快照的完整生命周期而设计，包括存储、索引、检索和清理。该技能确保系统状态的可靠保存和高效管理，为状态恢复和版本追踪提供坚实基础。"
zh-Hant = "snapshot_store是Epieikeia智能體的核心技能，專為管理容器快照的完整生命週期而設計，包括儲存、索引、檢索和清理。該技能確保系統狀態的可靠保存和高效管理，為狀態恢復和版本追蹤提供堅實基礎。"
