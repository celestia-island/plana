...
zh-Hans = "联邦工作区同步技能为 Kalos 代理提供跨设备和平台同步工作区文件的能力。此技能使用高级同步算法确保数据一致性、完整性和效率，支持多设备协作和分布式开发场景。"
zh-Hant = "聯邦工作區同步技能為 Kalos 代理提供跨裝置和平台同步工作區檔案的能力。此技能使用進階同步演算法確保資料一致性、完整性和效率，支援多裝置協作和分散式開發場景。"
