...
es = "Limpiar o archivar por lotes los elementos TODO completados. Admite modo de vista previa para ver los elementos a limpiar antes de la ejecución."
ru = "Пакетная очистка или архивирование завершенных элементов TODO. Поддерживается режим предварительного просмотра для просмотра очищаемых элементов перед выполнением."
+++
