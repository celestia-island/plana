...
es = "Consultar datos de series temporales de una métrica dentro de un rango de tiempo especificado"
ru = "Запросить данные временных рядов для метрики в указанном временном диапазоне"
+++
