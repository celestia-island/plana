...
es = "Descubrir contenido internacionalizado, elegir un idioma base y orquestar la sincronización de traducciones"
ru = "Обнаружение интернационализированного контента, выбор базового языка и координация синхронизации переводов"
