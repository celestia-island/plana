...
es = "Revisión de arquitectura : análisis de dependencias + métricas de calidad + mapeo de símbolos → informe de evaluación estructural"
ru = "Ревью архитектуры : анализ зависимостей + метрики качества + маппинг символов → отчёт оценки структуры"
